...
Примечание: данными продукциями описывается язык булевой
логики (в окне ввода текста замените символы эквивалентными по
смыслу).

## Язык
Язык L(G[E], порождаемый грамматикой G[E]:
L(G[E]) = {((p⇒q)∧¬r)∨s⇒t}
## Классификация грамматики
Согласно классификации Хомского, грамматика G[E] является контекстно-свободной, так как имеет вид:
A → α, где A∈VN, α∈V*.
## Схема вызова
![поопор](https://github.com/user-attachments/assets/ad8ffcf0-3d42-421f-b8d5-fed93ac12b0e)


## Тестовые примеры
![image](https://github.com/user-attachments/assets/47ff710d-d178-48d6-9f14-cb59f96c2f73)
![image](https://github.com/user-attachments/assets/d67f6ba4-5172-45fc-bfbf-2d034c433667)
![image](https://github.com/user-attachments/assets/203b2284-2fd8-426a-badf-741217aa6f64)
